...
object LegacySearchResult extends HasNullableSeq {
  ...
  implicit val legacySearchResultWrites: Writes[LegacySearchResult] = (
  ...
  )(unlift(LegacySearchResult.unapply))
